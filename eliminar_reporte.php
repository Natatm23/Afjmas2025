...
<!-- Contenido -->
<div class="content">
    <h1>🗑️ Eliminar Reporte</h1>
    <!-- FORMULARIO PARA BUSCAR CAMBIARLOS DESPUESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS-->
    ...
    <form action="guardar_edicion.php" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="boton-generar">🗑️ Eliminar Reporte</button>
    </form>
